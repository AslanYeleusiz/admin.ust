                                    ...
                                    <tr class="odd even">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <input v-else v-model="turnirQuestion.answer2" type="text" class="form-control" />
                                            </div>
                                            <validation-error :field="`answers.${index}.text`" />
                                        </td>
                                    </tr>
                                    <tr class="odd even">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <input v-else v-model="turnirQuestion.answer3" type="text" class="form-control" />
                                            </div>
                                            <validation-error :field="`answers.${index}.text`" />
                                        </td>
                                    </tr>
                                    <tr class="odd even">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <input v-else v-model="turnirQuestion.answer4" type="text" class="form-control" />
                                            </div>
                                            <validation-error :field="`answers.${index}.text`" />
                                        </td>
                                    </tr>
...
//                extraPlugins: [this.uploader],
    ...
    methods: {
        submit() {
            this.$inertia.post(
                route("admin.turnirQuestions.store", {turnir: this.turnir_id}),
                this.turnirQuestion,
                {
