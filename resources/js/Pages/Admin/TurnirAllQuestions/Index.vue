<template>
       <head>
        <title>Админ панель | Турнир | Сұрақтар</title>
    </head>
    <AdminLayout>
        ...
        <template #header>
            <div class="buttons d-flex align-items-center">
                <Link
                    ...
                    :href="route('admin.turnirAllQuestions.index')"
                >
                            ...
                            >
                                ...
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td>{{ turnirQuestion.turnir.name }}</td>
                                        <td>{{ getCategory(turnirQuestion.turnir.category) }}</td>
                                        <td>
                                            <span
...
<!--
                                                <Link
                                                    :href="
                                                        route(
                                                            'admin.turnirAllQuestions.comments',
                                                            { id: turnirQuestion.id }
                                                        )
                                                    "
    ...
    methods: {
        deleteData(id) {
              Swal.fire({
                ...
                this.$inertia.delete(route("admin.turnirAllQuestions.destroy", id));
                }
            });
        ...
        search() {
            ...
            this.$inertia.get(route("admin.turnirAllQuestions.index"), params);
        },
    },
};
</script>
