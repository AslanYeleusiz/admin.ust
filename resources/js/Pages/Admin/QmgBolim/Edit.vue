                ...
                <form method="post" @submit.prevent="submit">
                    <div class="card-body">
                        ...
                        <div class="form-group file-upload">
                            ...
                            <div class="ml-2">
                                <img v-if="qmgBolim.path && !image.file" :src="route('admin.index')+'/storage/files/' +  qmgBolim.path" height="300" alt="image" style="padding-bottom: 10px" />
...
export default {
    ...
    methods: {
        submit() {
            this.qmgForm = this.$inertia.form({
                _method: 'put',
                title: this.qmgBolim.title,
                date: this.qmgBolim.date,
                synyp_text: this.qmgBolim.synyp_text,
                sub_id: this.qmgBolim.sub_id,
                skidka: this.qmgBolim.skidka,
                path: this.qmgBolim.path,
                video: this.qmgBolim.video,
                doc: this.qmgBolim.doc,
                newPath: this.image.file,
                newDoc: this.file.file,
            }),
            this.$inertia.post(
                route("admin.qmgBolim.update", this.qmgBolim.id),
                this.qmgForm,
                {
